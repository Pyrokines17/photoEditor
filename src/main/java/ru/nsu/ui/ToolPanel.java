    ...
    private JButton getSaveButton() {
        ...
        saveButton.addActionListener(notUsed -> {
            if (savingStrategy == null) {
                JOptionPane.showMessageDialog(null, "Saving error", "Internal error", JOptionPane.ERROR_MESSAGE);
                return;
            }
    ...
    private JButton getLoadButton() {
        ...
        loadButton.addActionListener(notUsed -> {
            if (loadStrategy == null) {
                JOptionPane.showMessageDialog(null, "Loading error", "Internal error", JOptionPane.ERROR_MESSAGE);
                return;
            }
